...
class FChatLib {
	...
	leaveListener(argument) {
		...
		Object.keys(parent.channels).forEach(function(room) {
			if (parent.channels[room].private == "false") { return 0; }
			console.log("meow1");
			if (argument.channel == room || argument.channel == "meow meow") {
				console.log("meow2");
				if (parent.channels[room].users == null) { return 0; }
				console.log("meow3");
				parent.channels[room].users.forEach(function(user, index) {
					...
					console.log(user);
					console.log(index);
					console.log(JSON.stringify(parent.channels[room].users));
					if (parent.channels[room].users[index].identity == argument.character) {
						console.log("meow5");
						parent.channels[room].users.splice(index, 1);
    ...
    startWebsockets(json) {
		...
		if (conecting == true) { console.log("Already connecting..."); return 0; }
		conecting = true;
		...
		connectionTimeout = setInterval(function() { console.log("No reply from the WebSocket library, retrying..."); conecting = false; parent.connect(); }, 10000);
