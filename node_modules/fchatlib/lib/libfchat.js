...
var discordRooms = [
	...
	{flist: "adh-1fbc3bb1cc55e5261aa8", discord: "505092247315021825"},
...
class FChatLib {
    ...
    constructor(options){
		...
		if (this.config.rooms == "normal") {
			if (this.config.discord == "true") { this.connectDiscord(); }
			try {
	...
	connectDiscord() {
		...
		bot.on('message', function (user, userID, channelID, message, evt) {
			if (channelID == "495737115225751564" || channelID == "507640768941260830") { return 0; }
